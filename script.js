document.addEventListener("DOMContentLoaded", () => {
    ...
    /* =========================================================
       STUDENT AUTHENTICATION / ROUTE PROTECTION
    ========================================================= */
            ...
            async (event) => {
                ...
                try {
                    ...
                    if (
                        ...
                        msg =
                            "Cannot connect to backend server. Make sure Flask is running (python app.py) and open http://127.0.0.1:5000 in your browser.";
        ...
        complaintForm.addEventListener(
            ...
            async (event) => {
                ...
                if (!rollNo) {
                    ...
                    alert(
                        "Student Roll Number not found. Please log in first."
                    );
    ...
    if (complaintsContainer) {
                    ...
                    row.innerHTML = `
                        ...
                        <td>
                            ...
                            <strong>
                                ...
                                ${complaint.recipient || "Class Teacher"}
            ...
            const filtered =
                allComplaints.filter(
                    (complaint) => {
                        ...
                        const matchesSearch =
                            !searchValue ||
                            searchableComplaintId.includes(
                                searchValue
                            ) ||
                            searchableRollNo.includes(
                                searchValue
                            ) ||
                            searchableBranch.includes(
                                searchValue
                            ) ||
                            searchableRecipient.includes(
                                searchValue
                            );
        ...
        async function viewComplaint(
            ...
            try {
                ...
                const response =
                    await fetch(
                        `${API_BASE}/api/admin/complaints/${encodeURIComponent(
                            complaintId
                        )}/view`
                    );
